...
/* harmony export */   "I": function() { return /* binding */ setter; },
/* harmony export */   "K": function() { return /* binding */ EVENT; }
/* harmony export */ });
...
;// CONCATENATED MODULE: external "@metis.io/middleware-client"
var middleware_client_namespaceObject = require("@metis.io/middleware-client");;
...
var NavDropdown_namespaceObject = require("react-bootstrap/NavDropdown");;
...
// EXTERNAL MODULE: ./components/variables/Events.tsx
var Events = __webpack_require__(3847);
...
function Header({
  ...
  var c = new Date(Events/* EVENT.EndDateTime */.K.EndDateTime).getTime();
  ...
  async function login() {
    let oauth2Client = new middleware_client_namespaceObject.Oauth2Client();
    ...
    children: /*#__PURE__*/jsx_runtime_.jsx((Navbar_default()), {
      ...
      children: /*#__PURE__*/(0,jsx_runtime_.jsxs)((Container_default()), {
        children: [/*#__PURE__*/jsx_runtime_.jsx(next_link.default, {
          ...
          className: "me-auto",
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)((NavDropdown_default()), {
            title: "Donate",
            id: "project-dropdown",
            children: [/*#__PURE__*/jsx_runtime_.jsx(next_link.default, {
              href: "/projects/erc-721",
              children: /*#__PURE__*/jsx_runtime_.jsx("a", {
                children: /*#__PURE__*/jsx_runtime_.jsx((NavDropdown_default()).Item, {
                  as: "div",
                  children: "NFT"
                })
              })
          ...
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)((Nav_default()), {
            children: [id ? /*#__PURE__*/jsx_runtime_.jsx(jsx_runtime_.Fragment, {}) : /*#__PURE__*/jsx_runtime_.jsx((Nav_default()).Item, {
              className: "px-2",
              ...
              className: "px-2",
              children: user ? /*#__PURE__*/(0,jsx_runtime_.jsxs)("h5", {
  ...
  (0,external_react_.useEffect)(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const res = await external_axios_default().get(`${process.env.NEXT_PUBLIC_URL}/api/metis?code=${query.code}`);
        console.log(res);
        ...
        if (res.status === 200 && res.data && res.data.code === 200) {
          ...
          const httpClient = new middleware_client_namespaceObject.HttpClient(process.env.NEXT_PUBLIC_APP_ID || '', accessToken, refreshToken, expiresIn);
          setHttpClient(httpClient);
          const oauth2Client = new middleware_client_namespaceObject.Oauth2Client();
...
var __webpack_exports__ = __webpack_require__.X(0, [664], function() { return __webpack_exec__(1728); });
